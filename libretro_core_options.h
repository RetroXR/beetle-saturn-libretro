...
struct retro_core_option_v2_definition option_defs_us[] = {
   ...
   },
   {
      ...
      "CD Image Cache",
      NULL,
      "Load the complete image in memory at startup. Restart required.",
      NULL,
      "system",
      {
         { "disabled", NULL },
   ...
   },
   {
      ...
      "Mouse Sensitivity",
      NULL,
      "Configure the sensitivity of the 'Mouse' device type.",
      NULL,
      "input",
      {
         { "5%",   NULL },
   ...
   },
   {
      ...
      "Gun Input Mode",
      NULL,
      "Choose the lightgun input mode.",
      NULL,
      "input",
      {
         { "Lightgun",    NULL },
   ...
   },
   {
      ...
      "Gun Crosshair",
      NULL,
      "Choose the crosshair for the 'Stunner' and 'Virtua Gun' device types.",
      NULL,
      "input",
      {
         { "Off",   "disabled" },
   ...
   },
   {
      ...
      NULL,
      "Enable shared internal memory. Restart required.",
      NULL,
      "memcards",
      {
         { "disabled", NULL },
   ...
   },
   {
      ...
      "Shared Backup Memory",
      NULL,
      "Enable shared backup memory. Restart required.",
      NULL,
      "memcards",
      {
         { "disabled", NULL },
